...
public class PdBase extends NSObject {
	 ...
	 */
	@Method(selector = "addToSearchPath:")
	public static native void addToSearchPath(NSString path);
	 ...
	 */
	@Method(selector = "dollarZeroForFile:")
	public static native int dollarZeroForFile(VoidPtr x);
	
	/**
	 * + (void)computeAudio:(BOOL)enable;
	 */
	@Method(selector = "computeAudio:")
	public static native void computeAudio(boolean enable);
